...
{
    /// <inheritdoc />
    public partial class AddUserFollowingToEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("194acb3a-d965-480a-881b-0a4e33739fb7"), null, "Member", "MEMBER" },
                    { new Guid("20dff262-41fa-4caf-be62-003bc71e112b"), null, "Moderator", "MODERATOR" },
                    { new Guid("68056a8b-6519-4fe8-a99a-d07298bd5f46"), null, "BannedUser", "BANNED_USER" },
                    { new Guid("9e00c98a-c610-4d44-9857-1a289c718e8a"), null, "User", "USER" },
                    { new Guid("b6abc63d-5ebe-416c-a98a-e00459b17f88"), null, "Admin", "ADMIN" }
                });
